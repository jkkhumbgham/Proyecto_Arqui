package com.puj.security.exception;
...
/**
 * Mapea excepciones JAX-RS a respuestas JSON uniformes.
 * Compartido por todos los microservicios vía libs/security.
 */
@Provider
    ...
    public Response toResponse(Exception ex) {
        ...
        if (ex instanceof jakarta.validation.ConstraintViolationException e) {
            String msg = e.getConstraintViolations().stream()
                    ...
                    .reduce((a, b) -> a + "; " + b).orElse("Datos de entrada inválidos.");
